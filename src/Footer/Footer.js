...
const Footer = () => {
    return (
        <div>
            ...
            <div>
                <img src={product_icon} className={styles.product_icon} />
            ...
            <div>
                <img src={themes_icon} className={styles.themes_icon} />
            ...
            <div>
                <img src={company_icon} className={styles.company_icon} />
            ...
            <div>
                <img src={support_icon} className={styles.support_icon} />
            ...
            <img src={email_icon} className={styles.email_icon} />
            <p className={styles.email_text}>Отримуйте знижки та подарунки щотижня!</p>
            <form>
                <img src={email_input_icon} className={styles.email_input_icon} />
            ...
            <img src={fb_icon} className={styles.fb_icon} />
            <img src={google_icon} className={styles.google_icon} />
            <img src={pint_icon} className={styles.pint_icon} />
            <img src={twit_icon} className={styles.twit_icon} />
